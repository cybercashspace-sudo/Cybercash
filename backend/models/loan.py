...
class Loan(Base):
    ...
    base_fee_percentage = Column(Numeric(20, 2), default=0.0)
    base_fee_amount = Column(Numeric(20, 2), default=0.0)
    late_fee_percentage = Column(Numeric(20, 2), default=0.0)
    late_fee_amount = Column(Numeric(20, 2), default=0.0)
    late_fee_applied_at = Column(DateTime(timezone=True), nullable=True)
    outstanding_balance = Column(Numeric(20, 2), nullable=False)
