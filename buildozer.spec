...
source.exclude_patterns = .env,.env.*,backend/.env,**/.env,**/.env.*,*.log,*.pdb,*.dll,*.exe,*.pyc,*.db,*.env,*.key,package-lock.json,package.json,user_data.json,session.json,start_test.txt,README*,LICENSE*,CYBERCASH_FULL_APP.zip,*/__pycache__/*,__pycache__/*
version = 1.0.0
requirements = python3,kivy,kivymd==1.2.0,requests,certifi,charset_normalizer,python-dotenv,pyjnius,cryptography
