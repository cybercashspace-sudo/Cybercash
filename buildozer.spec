...
version = 1.0.0
requirements = python3,kivy,https://github.com/kivymd/KivyMD/archive/master.zip,materialyoucolor,exceptiongroup,asyncgui,asynckivy,Pillow,requests,certifi,charset_normalizer,python-dotenv,pyjnius
